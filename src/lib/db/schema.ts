...
export const insertPrayerTime = createInsertSchema(prayertimes, {
    ...
    fajr: (item) => item.fajr.regex(/^[0-9]{2}:[0-9]{2}$/).or(z.string().default("00:00")),
    sunrise: (item) => item.sunrise.regex(/^[0-9]{2}:[0-9]{2}$/).or(z.string().default("00:00")),
    dhuhr: (item) => item.dhuhr.regex(/^[0-9]{2}:[0-9]{2}$/).or(z.string().default("00:00")),
    asr: (item) => item.asr.regex(/^[0-9]{2}:[0-9]{2}$/).or(z.string().default("00:00")),
    maghrib: (item) => item.maghrib.regex(/^[0-9]{2}:[0-9]{2}$/).or(z.string().default("00:00")),
    isha: (item) => item.isha.regex(/^[0-9]{2}:[0-9]{2}$/).or(z.string().default("00:00")),
});
